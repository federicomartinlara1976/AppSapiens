 ...
 *
 */
public class DefinicionCamposGlosarioTableCamposModel extends DefaultTableModel<CampoGlosario> {
	 ...
	 * @param columnClasses
	 */
	public DefinicionCamposGlosarioTableCamposModel(List<String> columnNames, List<Class<?>> columnClasses) {
	 ...
	 * @param columnClasses
	 */
	public DefinicionCamposGlosarioTableCamposModel(List<CampoGlosario> data, List<String> columnNames, List<Class<?>> columnClasses) {
