...
public class FrmValoresParticulas extends FrameSupport {
	...
	private void initComponents() {
		...
		tblTiposParticular
				.setModel(new DefaultTableModel(
						new Object[][] { { null, null, null }, { null, null, null }, { null, null, null },
								{ null, null, null } },
						new String[] { "COD_PARTICULA", "DES_PARTICULA", "MCA_PROYECTO" }) {
		...
		tblValoresPosibles.setModel(new DefaultTableModel(
				...
				new String[] { "COD_PARTICULA", "VAL_PARTICULA", "DES_VAL_PART", "VAL_PART_PADRE", "COD_USR",
						"FEC_ACTU" }) {
				...
				.addGroup(GroupLayout.Alignment.TRAILING,
						layout.createSequentialGroup().addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								...
								.addComponent(btnBajaElemento, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(btnModificacionElemento).addContainerGap())
						...
						.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addGroup(
										layout.createParallelGroup(
												GroupLayout.Alignment.TRAILING).addComponent(jLabel4)
										...
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addGroup(layout.createSequentialGroup()
														...
														.addGroup(layout
																...
																.addComponent(cmbProyecto, GroupLayout.PREFERRED_SIZE,
																		GroupLayout.DEFAULT_SIZE,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(txtCodigo, GroupLayout.PREFERRED_SIZE,
																		212, GroupLayout.PREFERRED_SIZE))
														.addPreferredGap(
																LayoutStyle.ComponentPlacement.RELATED, 29,
																Short.MAX_VALUE)
														.addGroup(layout
																.createParallelGroup(GroupLayout.Alignment.LEADING)
														...
														.addGroup(layout
																...
																.addGroup(layout.createSequentialGroup()
																		...
																		.addComponent(btnBuscar,
																				...
																				GroupLayout.PREFERRED_SIZE)))
														.addGap(557, 557, 557))
												.addGroup(layout.createSequentialGroup().addGap(362, 362, 362)
						...
						.addGroup(
								layout.createSequentialGroup().addGap(18, 18, 18)
										...
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
												...
												.addComponent(cmbSubproyecto, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										...
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 259,
														Short.MAX_VALUE)
